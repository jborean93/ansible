...
class ActionModule(ActionBase):
    ...
    def _copy_file(self, source_full, source_rel, content, content_tempfile,
        ...
        if local_checksum != dest_status['checksum']:
            ...
            module_return = self.execute_module(module_name='ansible.legacy.copy', module_args=new_module_args, task_vars=task_vars)
            ...
            module_return = self.execute_module(module_name='ansible.legacy.file', module_args=new_module_args, task_vars=task_vars)
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        # look up the files and use the first one we find as src
            ...
            result.update(self.execute_module(module_name='ansible.legacy.copy', task_vars=task_vars))
            return self._ensure_invocation(result)
        else:
